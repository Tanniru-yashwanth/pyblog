...
class HomePageTest(TestCase):
    def test_root_url_resolves_to_home_page(self):
        """
        Test to check whether the root url is resolving to index view function.
        """
        found = resolve("/")
    ...
    def test_home_url_return_index_page(self):
        """
        Test to check whether the url returns the index page.
        """
...
class TopicsPageTest(TestCase):
    def test_topics_url(self):
        """
        Test to check whether the topics url is resolving to the topics view function.
        """
    ...
    def test_topics_url_return_topics_page(self):
        """
        Test to check whether the topics url return the topics page.
        """
...
class TopicDetailTest(TestCase):
    def test_topic_detail_url(self):
        """
        Test to check whether the topic detail url resolving to topic detail view function.
        """
...
class LoginTest(TestCase):
    def test_login_redirects(self):
        """
        Test to check whether the login page redirects after filling the credentials.
        """
